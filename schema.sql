...
CREATE TABLE IF NOT EXISTS `players` (
  ...
  `lookwings` smallint unsigned NOT NULL DEFAULT '0',
  `lookaura` smallint unsigned NOT NULL DEFAULT '0',
  `lookshader` smallint unsigned NOT NULL DEFAULT '0',
...
-- Visual selections (wings/aura) persisted per player
CREATE TABLE IF NOT EXISTS `player_visuals` (
  `player_id` int NOT NULL,
  `wings` smallint unsigned NOT NULL DEFAULT '0',
  `aura` smallint unsigned NOT NULL DEFAULT '0',
  `shader` smallint unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`player_id`),
  FOREIGN KEY (`player_id`) REFERENCES `players`(`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARACTER SET=utf8;
